# -*- coding: utf-8 -*-
"""
Created on Thu Jul 15 17:09:49 2021
...
def get_rank_stock():
    ...
    title_line = response.html.xpath("//div[(contains(@class, 'table-header-wrapper'))]") # 標題列
    title_line_list = title_line[0].text.split('\n') # 標題列 -> list型式
    # for each_title in title_line:
        # print(each_title.text)
    
    rows = response.html.xpath("//li[@class='List(n)']") # 每一筆數據資料
    data = {}
