        ...
        if RunMode == '1' or RunMode == '3':
            ...
            while mainArea != None and girlListShop != None and girlList != list():
                ...
                page_number  = page_number  +1
                 #開始逐步搜尋
                try: mainArea, girlListShop, girlList = request_url(page_number)
                except: pass
            ...
            for i in range(0, len(Excel_todo_list)):
                ...
                try:
                    ...
                    for index_i , each_content in enumerate(descriptions): 
                        ...
                        # if index_i % 2 == 0 : list_title.append(each_content.text.replace(' ',""))
                        # else list_content : 
                        print(str(index_i), repr(each_content.text.replace(' ',"")))    
