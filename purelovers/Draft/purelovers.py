    ...
    try:
        ...
        if RunMode == '1' or RunMode == '3':
            ...
            try: 
                ...
                if girlList == []: raise Exception('Download Error') #檢查是否有抓到關鍵值
            except:
            ...
            for each_girl in girlList:
                ...
                try: #錯誤處理
                    ...
                    name = girl_name[:girl_name.find('(')].replace("'","").strip() #女孩姓名
                    ...
                    # 字典{人名:URL}
                    GirlList_Dic[girl_name] = each_girl.find("a").get('href')
            ...
            if not len(girlList) == alredy_download + Download_Exception: 
